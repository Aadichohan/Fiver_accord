...
$(document).ready(function() {
  ...
  faqSearchInput.on('change keyup', function(e) {
  // faqSearchInput.on('keyup keydown change paste', function(e) {
   // console.log('script');
   if(e.which == 13) {
        faqSearch();
    }
  ...
  if (faq_term_length) {
    ...
    $('.faq_subaccordion h3').each(function() {
      ...
      if (title_includes_term) {
       ...
       // console.log('else h3 '+top_accord_id);
        const not_top_accordion = last_top_accord_id != top_accord_id;
